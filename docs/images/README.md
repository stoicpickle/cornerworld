...
These screenshots are captured from deterministic local Cornerworld runs and
are used by the repository README. They should not contain unrelated desktop
content or private information.
